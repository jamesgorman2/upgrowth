...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "c78274ab9f4495dcd99e";
...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar React = __importStar(__webpack_require__(/*! react */ \"./node_modules/react/index.js\"));\r\nvar react_redux_1 = __webpack_require__(/*! react-redux */ \"./node_modules/react-redux/es/index.js\");\r\nvar Paper_1 = __importDefault(__webpack_require__(/*! @material-ui/core/Paper */ \"./node_modules/@material-ui/core/esm/Paper/index.js\"));\r\nvar core_1 = __webpack_require__(/*! @material-ui/core */ \"./node_modules/@material-ui/core/esm/index.js\");\r\nvar withWidth_1 = __webpack_require__(/*! @material-ui/core/withWidth */ \"./node_modules/@material-ui/core/esm/withWidth/index.js\");\r\nvar useStyles = core_1.makeStyles(function (theme) {\r\n    return core_1.createStyles({\r\n        root: {\r\n            display: 'flex',\r\n            flexWrap: 'wrap',\r\n            justifyContent: 'space-around',\r\n            overflow: 'hidden',\r\n            backgroundColor: theme.palette.background.paper,\r\n        },\r\n        gridList: {\r\n            width: '100%',\r\n        },\r\n        icon: {\r\n            color: 'rgba(255, 255, 255, 0.54)',\r\n        },\r\n        titleTitle: {\r\n            height: '24px'\r\n        }\r\n    });\r\n});\r\nvar PhotoList = function (_a) {\r\n    var photos = _a.photos, errorMessage = _a.errorMessage, width = _a.width;\r\n    var classes = useStyles();\r\n    var cols = function () {\r\n        if (withWidth_1.isWidthUp('xl', width)) {\r\n            return 5;\r\n        }\r\n        if (withWidth_1.isWidthUp('lg', width)) {\r\n            return 4;\r\n        }\r\n        if (withWidth_1.isWidthUp('md', width)) {\r\n            return 3;\r\n        }\r\n        if (withWidth_1.isWidthUp('sm', width)) {\r\n            return 2;\r\n        }\r\n        return 1;\r\n    };\r\n    var photoList = function (photos) {\r\n        return React.createElement(core_1.GridList, { cellHeight: 360, cols: cols(), className: classes.gridList }, photos.map(function (photo) {\r\n            return React.createElement(core_1.GridListTile, { key: photo.id },\r\n                React.createElement(\"img\", { src: photo.urls.small, alt: photo.description }),\r\n                React.createElement(core_1.GridListTileBar, { title: React.createElement(\"span\", { className: classes.titleTitle },\r\n                        photo.description,\r\n                        \"\\u00A0\"), subtitle: React.createElement(\"span\", null,\r\n                        \"by: \",\r\n                        photo.user.name || '&nbsp;') }));\r\n        }));\r\n    };\r\n    // TODO searching and error behaviour\r\n    return React.createElement(Paper_1.default, null, photos != undefined ? photoList(photos) : null);\r\n};\r\nfunction stateToProps(state) {\r\n    return state;\r\n}\r\nvar PhotosContainer = react_redux_1.connect(stateToProps)(core_1.withWidth()(PhotoList));\r\nexports.default = PhotosContainer;\r\n\n\n//# sourceURL=webpack:///./src/components/photos.tsx?");
